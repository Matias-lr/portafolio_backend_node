...
const {DepartamentoSelect,DepartamentoCreate,DepartamentoUpdate,DepartamentoByEdificio,DepartamentoDelete,DepaByNameId,DepaId} = require('../controllers/DepartamentoController')
